...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#00346D" },
      { property: "og:title", content: "MD Al Amin — 10 Cent Agency" },
      { property: "og:description", content: "Founder & CEO of 10 Cent Agency. Tap to save contact or message on WhatsApp." },
